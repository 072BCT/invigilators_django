...
urlpatterns = [
    ...
    path('examCenters/',views.exam_centers_lv,name='examCenters_lv'),
    path('examCenter_add',addViews.examCenter_add,name='examCenter_add'),
    path('examCenter_edit/<int:pk>',editViews.examCenter_edit,name='examCenter_edit'),
    path('examCenter_remove/<int:pk>',deleteViews.examCenter_remove,name='examCenter_remove'),
